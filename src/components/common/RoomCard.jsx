...
import { ShareIcon, ArrowPathIcon, HeartIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className='bg-white rounded-lg shadow-md overflow-hidden group flex flex-col h-full'>
      ...
      <div className='p-4 flex flex-col flex-grow'>
        <h3 className='text-lg font-semibold text-gray-800 mb-2'>{product.roomName}</h3>
        <p className='text-sm text-gray-600 mb-2 flex-grow line-clamp-2'>{product.description}</p>
